...
export interface ParserServices {
  ...
  readonly convertElementSourceSpanToLoc: (
...
export function ensureTemplateParser(
  ...
  if (
    !(context.parserServices as unknown as ParserServices)?.convertNodeSourceSpanToLoc ||
    !(context.parserServices as unknown as ParserServices)?.convertElementSourceSpanToLoc
  ) {
    /**
